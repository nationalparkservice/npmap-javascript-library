    ...
    createCartoDbLayer: function(options) {
      ...
      return new CartoDBLayer({
        ...
        featureOver: function(feature, latlng, pos, data) {
          me.setCursor('pointer');
        },
        interactivity: 'cartodb_id',
        map: map,
        opacity: options.opacity,
        query: options.query || 'SELECT * FROM {{table_name}}',
        table_name: options.table,
        tile_style: options.style || null,
