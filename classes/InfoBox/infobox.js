    ...
    show: function(content, title, footer, actions, styles, target) {
      ...
      bottomHeight = $('#npmap-infobox-bottom').actual('outerHeight');
	    footerHeight = (function() {
	      if (hasFooterContent) {
	        return $('#npmap-infobox-footer').actual('outerHeight');
	      } else {
	        return 0;
	      }
	    })();
