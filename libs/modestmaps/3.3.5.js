 ...
 * Easey
 */
(function(w,f){var q=function(){function l(a,o,c){return 0===c?a:1===c?o:a+(o-a)*c}var c={},d=!1,i=!1,m,g={easeIn:function(a){return a*a},easeOut:function(a){return Math.sin(a*Math.PI/2)},easeInOut:function(a){return(1-Math.cos(Math.PI*a))/2},linear:function(a){return a}},j=g.easeOut,b,h,e;c.stop=function(a){i=!0;b=void 0;m=a};c.running=function(){return d};c.point=function(a){h=e.pointCoordinate(a);return c};c.zoom=function(a){h||(h=e.coordinate.copy());h=e.enforceZoomLimits(h.zoomTo(a));return c};c.location=function(a){h=e.locationCoordinate(a);return c};c.from=function(a){if(!arguments.length)return b?b.copy():b;b=a.copy();return c};c.to=function(a){if(!arguments.length)return h.copy();h=e.enforceZoomLimits(a.copy());return c};c.path=function(a){r=p[a];return c};c.easing=function(a){j=g[a];return c};c.map=function(a){if(!arguments.length)return e;e=a;return c};var p={},k=new f.Coordinate(0,0,0);p.screen=function(a,o,c,b){var e=l(a.zoom,o.zoom,c);if(b)b.row=l(a.row,o.row*Math.pow(2,a.zoom-o.zoom),c)*Math.pow(2,e-a.zoom),b.column=l(a.column,o.column*Math.pow(2,a.zoom-o.zoom),c)*Math.pow(2,e-a.zoom),b.zoom=e;else return new f.Coordinate(l(a.row,o.row*Math.pow(2,a.zoom-o.zoom),c)*Math.pow(2,e-a.zoom),l(a.column,o.column*Math.pow(2,a.zoom-o.zoom),c)*Math.pow(2,e-a.zoom),e)};p.about=function(a,c,b,d){var b=l(a.zoom,c.zoom,b),h=e.dimensions.x/2,v=e.dimensions.y/2,i=e.tileSize.x,t=e.tileSize.y,s=h+i*(c.column*Math.pow(2,a.zoom-c.zoom)-a.column),g=v+t*(c.row*Math.pow(2,a.zoom-c.zoom)-a.row),h=h+i*(c.column*Math.pow(2,b-c.zoom)-a.column*Math.pow(2,b-a.zoom)),c=v+t*(c.row*Math.pow(2,b-c.zoom)-a.row*Math.pow(2,b-a.zoom));if(d)d.column=a.column*Math.pow(2,b-a.zoom)-(s-h)/i,d.row=a.row*Math.pow(2,b-a.zoom)-(g-c)/t,d.zoom=b;else return new f.Coordinate(a.column*Math.pow(2,b-a.zoom)-(s-h)/i,a.row*Math.pow(2,b-a.zoom)-(g-c)/t,b)};var r=p.screen;c.t=function(a){r(b,h,j(a),k);e.coordinate=k;e.draw();return c};c.future=function(a){for(var c=[],e=0;e<a;e++)c.push(r(b,h,e/(a-1)));return c};var n;c.resetRun=function(){n=+new Date;return c};c.run=function(a,o){function g(){var c=+new Date-n;if(i)return i=d=!1,m(),m=void 0;if(c>a){if(h.zoom!=b.zoom&&e.dispatchCallback("zoomed",h.zoom-b.zoom),d=!1,r(b,h,1,k),e.coordinate=k,h=b=void 0,e.draw(),o)return o(e)}else r(b,h,j(c/a),k),e.coordinate=k,e.draw(),f.getFrame(g)}if(d)return c.stop(function(){c.run(a,o)});b||(b=e.coordinate.copy());h||(h=e.coordinate.copy());a=a||1E3;n=+new Date;d=!0;f.getFrame(g)};c.optimal=function(a,d,i){function g(a){return a*a}function m(a){return(Math.exp(a)+Math.exp(-a))/2}function v(a){return(j*j-s*s+(a?-1:1)*Math.pow(d,4)*(A-C)*(A-C))/(2*(a?j:s)*(d*d)*(A-C))}a=a||0.9;d=d||1.42;b?e.coordinate=b:b=e.coordinate.copy();var B=e.pointCoordinate(new f.Point(0,0)).zoomTo(0),t=e.pointCoordinate(e.dimensions).zoomTo(0),s=Math.max(t.column-B.column,t.row-B.row),j=s*Math.pow(2,b.zoom-h.zoom),B=b.zoomTo(0),t=h.zoomTo(0),n=B.column,k=B.row,p=t.column,q=t.row,C=0,A=Math.sqrt((p-n)*(p-n)+(q-k)*(q-k)),u=Math.log(-v(0)+Math.sqrt(g(v(0))+1)),D=(Math.log(-v(1)+Math.sqrt(g(v(1))+1))-u)/d,E=function(a){return s*m(u)/m(d*a+u)},F=function(a){return s/(d*d)*m(u)*((Math.exp(d*a+u)-Math.exp(-(d*a+u)))/2/m(d*a+u))-s/(d*d)*((Math.exp(u)-Math.exp(-u))/2)+C};if(1E-6>Math.abs(A)){if(1E-6>Math.abs(s-j))return;var w=j<s?-1:1,D=Math.abs(Math.log(j/s))/d,F=function(){return C},E=function(a){return s*Math.exp(w*d*a)}}var G=r;r=function(a,c,b,d){if(1==b)return d&&(d.row=h.row,d.column=h.column,d.zoom=h.zoom),h;var b=b*D,c=F(b),a=a.zoom+Math.log(s/E(b))/Math.LN2,b=l(n,p,c/A||1),c=l(k,q,c/A||1),e=Math.pow(2,a);if(d)d.row=c*e,d.column=b*e,d.zoom=a;else return new f.Coordinate(c*e,b*e,a)};c.run(1E3*(D/a),function(a){r=G;i&&i(a)})};return c};this.easey=q;"undefined"==typeof this.mapbox&&(this.mapbox={});this.mapbox.ease=q})(this,MM);(function(w,f){function q(l,c){var d,i,m,g;function j(b){var k=Math.max(1,b-a);e&&p?n||(m=e.x-p.x,g=e.y-p.y,l.panBy(m,g),n=!0):(d*=Math.pow(1-c,60*k/1E3),i*=Math.pow(1-c,60*k/1E3),0.001>Math.abs(d)&&(d=0),0.001>Math.abs(i)&&(i=0),(d||i)&&l.panBy(d*k,i*k));a=b;h||f.getFrame(j)}var b={},c=c||0.15;g=m=i=d=0;var h=!1,e=null,p=null,k=null,r=null,n=!0,a=(new Date).getTime();b.down=function(a){e=p=f.getMousePoint(a,l);k=r=+new Date};b.move=function(a){e&&(n&&(p=e,r=k,n=!1),e=f.getMousePoint(a,l),k=+new Date)};b.up=function(){50>+new Date-r?(dt=Math.max(1,k-r),m=e.x-p.x,g=e.y-p.y,d=m/dt,i=g/dt):i=d=0;k=e=p=null};b.remove=function(){h=!0};f.getFrame(j);return b}this.easey_handlers={TouchHandler:function(){function l(){for(var a in n)n.hasOwnProperty(a)&&delete n[a]}function c(a){for(var c=0;c<a.touches.length;c+=1){var b=a.touches[c];if(b.identifier in n){var d=n[b.identifier];d.x=b.clientX;d.y=b.clientY;d.scale=a.scale}else n[b.identifier]={scale:a.scale,startPos:{x:b.clientX,y:b.screenY},startZoom:h.zoom(),x:b.clientX,y:b.clientY,time:(new Date).getTime()}}}function d(a){f.addEvent(a.touches[0].target,"touchmove",i);f.addEvent(a.touches[0].target,"touchend",j);a.touches[1]&&(f.addEvent(a.touches[1].target,"touchmove",i),f.addEvent(a.touches[1].target,"touchend",j));c(a);e.down(a.touches[0]);return f.cancelEvent(a)}function i(a){switch(a.touches.length){case 1:e.move(a.touches[0]);break;case 2:var b=a.touches[0],d=a.touches[1];x.x=b.clientX;x.y=b.clientY;y.x=d.clientX;y.y=d.clientY;l0=n[b.identifier];l1=n[d.identifier];l0.wasPinch=!0;l1.wasPinch=!0;b=f.Point.interpolate(x,y,0.5);h.zoomByAbout(Math.log(a.scale)/Math.LN2-Math.log(l0.scale)/Math.LN2,b);prevX=l0.x+0.5*(l1.x-l0.x);prevY=l0.y+0.5*(l1.y-l0.y);h.panBy(b.x-prevX,b.y-prevY);o=!0;w=b}c(a);return f.cancelEvent(a)}function m(a){easey().map(h).to(h.pointCoordinate(a).zoomTo(h.getZoom()+1)).path("about").run(200,function(){h.dispatchCallback("zoomed");l()})}function g(){var a=document.createElement("div");a.setAttribute("ongesturestart","return;");return"function"===typeof a.ongesturestart}function j(b){f.removeEvent(b.target,"touchmove",i);f.removeEvent(b.target,"touchend",j);var c=(new Date).getTime();if(0===b.touches.length&&o){var d=b.changedTouches[0],g=h.getZoom(),d=n[d.identifier].startZoom>g?Math.floor(g):Math.ceil(g);easey().map(h).point(w).zoom(d).path("about").run(300);l();o=!1}e.up();for(d=0;d<b.changedTouches.length;d+=1){var q=b.changedTouches[d];if((g=n[q.identifier])&&!g.wasPinch){var q={x:q.clientX,y:q.clientY},x=c-g.time;f.Point.distance(q,g.startPos)>k||(x>p?(q.end=c,q.duration=x):(q.time=c,g=q,a.length&&g.time-a[0].time<r?(m(g),a=[]):a=[g]))}}c={};for(d=0;d<b.touches.length;d++)c[b.touches[d].identifier]=!0;for(var y in n)y in c||delete c[y];return f.cancelEvent(b)}var b={},h,e,p=250,k=30,r=350,n={},a=[],o=!1,w=null,x=new f.Point(0,0),y=new f.Point(0,0);b.init=function(a){h=a;if(!g())return!1;f.addEvent(h.parent,"touchstart",d);e=q(h,0.1)};b.remove=function(){if(!g())return!1;f.removeEvent(h.parent,"touchstart",d);e.remove()};return b},DoubleClickHandler:function(){function l(c){f.getMousePoint(c,d);z=d.getZoom()+(c.shiftKey?-1:1);easey().map(d).to(d.pointCoordinate(f.getMousePoint(c,d)).zoomTo(z)).path("about").run(100,function(){d.dispatchCallback("zoomed")});return f.cancelEvent(c)}var c={},d;c.init=function(i){d=i;f.addEvent(d.parent,"dblclick",l);return c};c.remove=function(){f.removeEvent(d.parent,"dblclick",l)};return c},MouseWheelHandler:function(){function l(b){function c(){d.dispatchCallback("zoomed")}var e=0;g=g||(new Date).getTime();try{i.scrollTop=1E3,i.dispatchEvent(b),e=1E3-i.scrollTop}catch(j){e=b.wheelDelta||5*-b.detail}var k=(new Date).getTime()-g;m.running()?150<k&&(m.zoom(m.to().zoom+(0<e?1:-1)).from(d.coordinate).resetRun(),g=(new Date).getTime()):(f.getMousePoint(b,d),k=d.getZoom(),m.map(d).easing("easeOut").to(d.pointCoordinate(f.getMousePoint(b,d)).zoomTo(k+(0<e?1:-1))).path("about").run(100,c),g=(new Date).getTime());return f.cancelEvent(b)}var c={},d,i,m=easey(),g,j=!1;c.init=function(b){d=b;i=document.body.appendChild(document.createElement("div"));i.style.cssText="visibility:hidden;top:0;height:0;width:0;overflow-y:scroll";i.appendChild(document.createElement("div")).style.height="2000px";f.addEvent(d.parent,"mousewheel",l);return c};c.precise=function(b){if(!arguments.length)return j;j=b;return c};c.remove=function(){f.removeEvent(d.parent,"mousewheel",l);i.parentNode.removeChild(i)};return c},DragHandler:function(){function l(){g.parent.focus()}function c(b){if(!(b.shiftKey||2==b.button))return f.addEvent(document,"mousemove",d),f.addEvent(document,"mouseup",i),j.down(b),g.parent.style.cursor="move",f.cancelEvent(b)}function d(b){j.move(b);return f.cancelEvent(b)}function i(b){f.removeEvent(document,"mousemove",d);f.removeEvent(document,"mouseup",i);j.up();g.parent.style.cursor="";return f.cancelEvent(b)}var m={},g,j;m.init=function(b){g=b;f.addEvent(g.parent,"click",l);f.addEvent(g.parent,"mousedown",c);j=q(g)};m.remove=function(){f.removeEvent(g.parent,"click",l);f.removeEvent(g.parent,"mousedown",c);j.up();j.remove()};return m}}})(this,MM);